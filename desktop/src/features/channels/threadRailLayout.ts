...
export function threadRailShellClassName(_collapsed: boolean): string {
  return [
    "hidden mb-2 mr-2 mt-px h-[calc(100%-0.5625rem)] min-h-0 shrink-0 self-start overflow-hidden rounded-2xl bg-card/[0.95] shadow-content-edge ring-1 ring-border/30 ring-inset",
